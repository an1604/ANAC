...
def TSP_GA(points, muProb, generations=100):
    # PARAMS
    gen = 1
    ...
    if best_individual.fitness_val > population[0].fitness_val:
        best_individual = population[0]
    return best_individual.points_path  # To make sure we have no duplicate points in the best path


def solve(points):
    return TSP_GA(points=points, muProb=0.5)
